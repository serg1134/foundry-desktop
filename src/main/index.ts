...
function clearRuntimeCapabilities(projectId:string):void{clearRuntimeShortcuts(projectId);runtimeTrays.get(projectId)?.destroy();runtimeTrays.delete(projectId);runtimeDatabases.get(projectId)?.close();runtimeDatabases.delete(projectId);runtimeMenus.delete(projectId);runtimeDeepLinks.delete(projectId)}
